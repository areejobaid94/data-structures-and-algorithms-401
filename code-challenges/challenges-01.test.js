...
const addNumbers = (num, arr, times, callback) => {
  // Solution code here...
  new Array(times).fill(0).forEach( function(e) {
    callback(arr,num);
  });
  return arr;
};
...
const createList = (availableItems) => {
  ...
  availableItems.forEach( function(e) {
    e.available ? resArr.push(e.name) : e = e;
  });
  return resArr;
};
...
const fizzbuzz = (arr) => {
  ...
  console.log('aaa');
  arr.forEach( function(e) {
    (e % 5 == 0 &&  e % 3 == 0) ? resArr.push("Fizz Buzz") : (e % 3 == 0) ? resArr.push("Fizz") :  (e % 5 == 0)  ?  resArr.push("Buzz") : resArr.push(e);
  });
  console.log(resArr);
  return resArr;
};
